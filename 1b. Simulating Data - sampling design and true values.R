...
samp.des <- data.frame(n.pool = c(16,4,8,24, rep(16,14)),

                       n.year = c(rep(4,4), 2,8,20, rep(4,11)),

                       n.site = c(rep(4,7), 2,8,20, rep(4,8)),

                       n.visit = c(rep(4,10), 2,8,20, rep(4,5)),
                       ...
                       phi = c(rep(0.5,13), 0.2,0.8,0.8,0.5,0.5),
                       rho = c(rep(0.5,13), 0.2,0.8,0.2,0.5,0.5),
                       eps = c(rep(0.5,13), 0.2,0.8,0.2,0.5,0.5),

                       gamma = c(rep(0.5,13), 0.8,0.2,0.2,0.5,0.5),
                       lambda = c(rep(0.5,13), 0.8,0.2,0.8,0.5,0.5),
                       delta = c(rep(0.5,13), 0.8,0.2,0.8,0.5,0.5),

                       p = c(rep(0.5, 16), 0.2,0.8))
